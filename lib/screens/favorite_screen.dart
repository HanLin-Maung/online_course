...
//         child: FavoriteScreen.favoriteCourses.isNotEmpty
//             ? ListView.separated(
...
// to import flutter slidable package
import 'dart:convert';
import 'package:flutter/material.dart';
            ...
            ? ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Slidable(
                    endActionPane: ActionPane(
                      ...
                      children: [
                        SlidableAction(
                          ...
                          onPressed: (context) {
                            setState(() {
                              FavoriteScreen.favoriteCourses.remove(course);
                            });
                          },
                        )
                      ],
                    ...
                    //     onTap: () {
                    //       setState(() {
                    //         FavoriteScreen.removeFromFavorites(course);
                    //       });
                    //     },
                    //   ),
                    // ],
